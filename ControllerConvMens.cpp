...
void ControllerConvMens::archivarConversacion(){
  ...
  cout<<"------------------------------"<<endl;
      ...
      else
      {
        ...
        if(converPriv!=NULL)
        {
          ConversacionArchivada* converArch = new ConversacionArchivada(idconver, false, user, converPriv->getOtroParticipante(user));
          conver = converArch;
          ...
          converPriv->~ConversacionPrivada();
