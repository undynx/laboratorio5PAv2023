...
class InterfaceGrupo{
  public:
    ...
    virtual void agregarParticipante(int numTel, int id, Usuario *userLoggeado, DtFechaHora* fechaingreso) = 0;
    virtual void agregarAdministrador(int numTel, int id, Usuario *userLoggeado) = 0;
    virtual void eliminarParticipante(int numTel, int id,Usuario *userLoggeado) = 0;
